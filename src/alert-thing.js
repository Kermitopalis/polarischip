...
export class Alert extends LitElement {
  ...
  constructor() {
    super();
    this.issueLevel = ""
    this.message = "You should probably put something here";
    this.sticky = false;
    this.opened = true;
  ...
  toggleAlert() { 
    ...
    render() {
        ...
        if(this.issueLevel === "NOTICE") (this.message) = "NOTICE";
        if(this.issueLevel === "WARNING") (this.message) = "WARNING!"
        if(this.issueLevel === "ALERT") (this.message) = "IMMEDIATE ALERT!";
